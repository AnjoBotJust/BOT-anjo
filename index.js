...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:Affis Admin\n' 
            + 'ORG: Pengembang XBot;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=5527997141457:+55 27 997141457\n' 
            + 'END:VCARD' 
prefix = '!'
blocked = []          
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["5527997141457@s.whatsapp.net"] 
...
case 'lofi':
                ...
                case 'reportarbug':
                    ...
                    client.sendMessage('5527997141457@s.whatsapp.net', options, text, {quoted: mek})
            ...
            case 'criador':
            case 'anjo':
                  client.sendMessage(from, {displayname: "adm", vcard: vcard}, MessageType.contact, { quoted: mek})
